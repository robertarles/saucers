...
## Generation of the saucelabs api client (openapi-clientgen)

> openapi-generator generate -g rust -i <https://raw.githubusercontent.com/saucelabs/node-saucelabs/main/apis/sauce.json> -o src/codegen_saucelabs --skip-validate-spec
