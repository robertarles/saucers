...
impl InlineObject {
    pub fn new(assets: bool, browser: String, browser_display: String, browser_version_display: String, os: String, os_display: String, res: String, url: String, version: String) -> InlineObject {
        InlineObject {
            assets,
            browser,
            browser_display,
